...
public class RegisterTest {
    ...
    public void testeRegister() {
        ...
        registerPage.preencherNome("Diego");
        registerPage.preencherSegundoNome("Soares");
        registerPage.preencherEndereco("Rua Um Dois Tres da Silva Quatro");
        registerPage.preencherEmail("teste@teste.com");
        registerPage.PreencherTelefone("98765432");
        registerPage.clicarHobbies();
        registerPage.selecionarSkills("Java");
        registerPage.selecionarPais();
        registerPage.selecionarAno("1986");
        registerPage.selecionarMes("October");
        registerPage.selecionarDia("5");
